...
def configureDataBase():
    client = MongoClient("mongodb+srv://covid_chat:kirtish777@cluster0.drlts.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
    return client.get_database('covidDB')
